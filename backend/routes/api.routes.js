...
router.get('/get-all-payment-methods-withpagination', pro_controllers.getAllPaymentMethodsWithPagination)
...
router.get('/get/top-selling-products/chart', reportController.topsellinfProductsReportonChart)
